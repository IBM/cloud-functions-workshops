...
In this section, you will learn how to work with **actions** in IBM Cloud Functions. An action represents the serverless function, along with its conventions and metadata. If you recall, the _Action_ entity was shown as part of the IBM Cloud Functions programming model in the previous chapter.
